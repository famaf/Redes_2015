...
/*tabla arp donde se guardan las direcciones*/
struct arp_t{
    IPAddress ip_array[255];
    MACAddress mac_array[255];
    int count_register;
...
class Node : public cSimpleModule
{
  private:
    ...
    virtual int ip_index(IPAddress ip);
    virtual void add_arp_table(IPAddress new_ip, MACAddress new_mac);
